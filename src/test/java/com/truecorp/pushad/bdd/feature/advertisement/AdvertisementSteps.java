...
public class AdvertisementSteps extends AbstractTest {
	...
	public void user_login_pushad_with(String username, String password) throws MalformedURLException {
		...
		userNameEle = webDriver.findElement(By.xpath("html/body/div[1]/div[2]/form/div[2]/div/input"));
		userNameEle.sendKeys(username);
		paswordEle = webDriver.findElement(By.xpath("html/body/div[1]/div[2]/form/div[3]/div/input"));
	...
	public void user_input_data_in_form_advertisement_setup_page(String name) throws InterruptedException {
		jobName = name;
		...
		// job name
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[1]/div/div[2]/div[2]/div[2]/input")).sendKeys(name);
		// Job Description
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[1]/div/div[2]/div[3]/div[2]/textarea"))
				.sendKeys("วันศุกร์ 18:00");
		// SMS Body
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[1]/div/div[2]/div[4]/div[2]/textarea"))
				.sendKeys("มวยมันวันศุกร์  ทาง True4U");
		// Type of SIM
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[1]/div/div[2]/div[5]/div[2]/div/label[1]")).click();
		// Life Style
		new Select(
				webDriver.findElement(By.xpath(".//*[@id='create-form']/div[2]/div/div[2]/div[1]/div[2]/div/select")))
						.selectByValue("Boxing");
		new Select(
				webDriver.findElement(By.xpath(".//*[@id='create-form']/div[2]/div/div[2]/div[1]/div[4]/div/select")))
						.selectByValue("0");
		new Select(
				webDriver.findElement(By.xpath(".//*[@id='create-form']/div[2]/div/div[2]/div[1]/div[6]/div/select")))
						.selectByValue("10");
		// And Life Style
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[2]/div/div[2]/div[2]/div/label[1]/input")).click();
		Thread.sleep(4000);
		// sleep for get selection life style
		// Life Style 2
		new Select(webDriver.findElement(By.xpath(".//*[@id='lifestyle_2']/div[1]/div[2]/div/select")))
				.selectByValue("Funny");
		new Select(webDriver.findElement(By.xpath(".//*[@id='lifestyle_2']/div[1]/div[4]/div/select")))
				.selectByValue("0");
		new Select(webDriver.findElement(By.xpath(".//*[@id='lifestyle_2']/div[1]/div[6]/div/select")))
				.selectByValue("10");
		// True4U SMS Exclude
		webDriver.findElement(By.xpath(".//*[@id='CKture4uExclude']")).click();
		webDriver.findElement(By.xpath(".//*[@id='ture4uExclude']")).sendKeys("5");

		// True SMS Exclude
		webDriver.findElement(By.xpath(".//*[@id='CKtrueExclude']")).click();
		webDriver.findElement(By.xpath(".//*[@id='trueExclude']")).sendKeys("10");

		// User Time
		webDriver.findElement(By.xpath(".//*[@id='time']/tbody/tr[1]/td[1]")).click();
		webDriver.findElement(By.xpath(".//*[@id='time']/tbody/tr[1]/td[2]")).click();
		webDriver.findElement(By.xpath(".//*[@id='time']/tbody/tr[1]/td[3]")).click();
		...
		// Select Date
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[3]/div/div[2]/div[5]/div[2]/div/div/div/label[1]"))
				.click();
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[3]/div/div[2]/div[5]/div[2]/div/div/div/label[2]"))
				.click();
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[3]/div/div[2]/div[5]/div[2]/div/div/div/label[3]"))
				.click();
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[3]/div/div[2]/div[5]/div[2]/div/div/div/label[4]"))
				.click();
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[3]/div/div[2]/div[5]/div[2]/div/div/div/label[5]"))
				.click();
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[3]/div/div[2]/div[5]/div[2]/div/div/div/label[6]"))
				.click();
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[3]/div/div[2]/div[5]/div[2]/div/div/div/label[7]"))
				.click();
	...
	public void user_should_be_see_job_name_in_page_advertisement_setup_list(String jobNameUpdtate) {
		logger.info("user_should_be_see_job_name_in_page_advertisement_setup_list : {}", jobNameUpdtate);
		...
		if (size == 0) {
			try {
				WebElement findElement = webDriver.findElement(
						By.xpath(".//*[@id='adsetup']/tbody/tr/td/a[contains(text(),'" + jobNameUpdtate + "')]"));
				String attribute = findElement.getAttribute("href");
				jobId = attribute.replace(url + "/advertisement?adsid=", "");
			...
			try {
				...
				for (int i = 0; i <= size; i++) {
					webDriver.get(url + "/advertisement/setup/" + i);
					...
					if (webDriver.getPageSource().contains(jobNameUpdtate)) {
						WebElement findElement = webDriver.findElement(By
								.xpath(".//*[@id='adsetup']/tbody/tr/td/a[contains(text(),'" + jobNameUpdtate + "')]"));
						String attribute = findElement.getAttribute("href");
						jobId = attribute.replace(url + "/advertisement?adsid=", "");
						System.out.println("attribute : " + jobId);
						assertEquals(jobNameUpdtate, findElement.getText());
	...
	public void user_click_delete_job_name(String jobName) {
		WebElement findElement = webDriver
				.findElement(By.xpath(".//*[@id='adsetup']/tbody/tr/td/a[contains(text(),'" + jobName + "')]"));
		String attribute = findElement.getAttribute("href");
		jobId = attribute.replace(url + "/advertisement?adsid=", "");
		System.out.println("attribute : " + jobId);

		webDriver.findElement(By.xpath(
				".//*[@id='adsetup']/tbody/tr/td/div/div[2]/button[contains(@data-href,'delete/" + jobId + "')]"))
				.click();

		WebDriverWait waiting = new WebDriverWait(webDriver, 30, 2500);
		WebElement element;
		element = waiting.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath(".//*[@id='confirm-delete']/div/div/div[3]/div[1]/a")));
			...
			try {
				...
				for (int i = 0; i <= size; i++) {
					...
					if (webDriver.getPageSource().contains(jobName)) {
						WebElement findElement = webDriver.findElement(
								By.xpath(".//*[@id='adsetup']/tbody/tr/td/a[contains(text(),'" + jobName + "')]"));
						String attribute = findElement.getAttribute("href");
						jobId = attribute.replace(url + "/advertisement?adsid=", "");
						System.out.println("attribute : " + jobId);
						assertEquals(jobName, findElement.getText());
	...
	public void user_click_export(String arg1) throws InterruptedException {
		...
		try {
			webDriver.findElement(By.xpath(".//*[@id='adsetup']/tbody/tr/td[1][contains(text(), '" + arg1
					+ "')]/parent::tr/td[5]/a[contains(@href, 'export')]")).click();
		} catch (Exception e) {
	...
	public void user_click_re_run_job_name(String arg1) throws InterruptedException {
		...
		try {
			webDriver.findElement(By.xpath(".//*[@id='adsetup']/tbody/tr/td[1][contains(text(), '" + arg1
					+ "')]/parent::tr/td[5]/a[contains(@href, 'rerun')]")).click();
		} catch (Exception e) {
			fail("Can't found element export");
		}
	}
	...
	public void user_click_execute_Job() throws Throwable {
		...
		webDriver.findElement(By.xpath(".//*[@id='btnSeccion4']")).click();
	}
	...
	public void user_should_be_see_job_name_in_page_advertisement_list(String arg1, String arg2)
		...
		logger.info("user_should_be_see_job_name_in_page_advertisement_list, arg1: {}, arg2: {}", arg1, arg2);
		...
		if (size == 0) {
			try {
				WebElement findElement = webDriver
						.findElement(By.xpath(".//*[@id='adsetup']/tbody/tr/td[contains(text(),'" + jobName + "')]"));
				String attribute = findElement.getAttribute("href");
				jobId = attribute.replace(url + "/advertisement?adsid=", "");
				System.out.println("attribute : " + jobId);
				assertEquals(jobName, findElement.getText());
			...
			try {
				...
				for (int i = 0; i <= size; i++) {
					...
					if (webDriver.getPageSource().contains(jobName)) {
						WebElement findElement = webDriver.findElement(
								By.xpath(".//*[@id='adsetup']/tbody/tr/td[contains(text(),'" + jobName + "')]"));
						String attribute = findElement.getAttribute("href");
						jobId = attribute.replace(url + "/advertisement?adsid=", "");
						System.out.println("attribute : " + jobId);
						assertEquals(jobName, findElement.getText());
	...
	public void user_click_update_config_job_name(String arg1) throws InterruptedException {
		...
		try {
			webDriver.findElement(By.xpath(".//*[@id='adsetup']/tbody/tr/td[1][contains(text(), '" + arg1
					+ "')]/parent::tr/td[5]/a[contains(@href, 'savererun')]")).click();
		} catch (Exception e) {
	...
	public void user_update_data() throws Throwable {
		...
		Thread.sleep(3000);
		// Type of SIM
		webDriver.findElement(By.xpath(".//*[@id='create-form']/div[1]/div/div[2]/div[5]/div[2]/div/label[2]")).click();
	...
	@Then("^should be see job name \"([^\"]*)\" in page advertisement setup list$")
	public void should_be_see_job_name_in_page_advertisement_setup_list(String jobNameUpdtateConfig) {
		logger.info("user_should_be_see_job_name_in_page_advertisement_setup_list : {}", jobNameUpdtateConfig);

		int size = webDriver.findElements(By.xpath("html/body/div[1]/div[2]/div[4]/ul/li")).size();

		jobName = jobNameUpdtateConfig;
		logger.info("jobName: {}, size: {}", jobName, size);

		if (size == 0) {
			try {
				WebElement findElement = webDriver.findElement(
						By.xpath(".//*[@id='adsetup']/tbody/tr/td/a[contains(text(),'" + jobNameUpdtateConfig + "')]"));
				String attribute = findElement.getAttribute("href");
				jobId = attribute.replace(url + "/advertisement?adsid=", "");
				System.out.println("attribute : " + jobId);
				assertEquals(jobNameUpdtateConfig, findElement.getText());
			} catch (Exception e) {
				fail("Can't found element advertisement setup list");
			}
		} else {
			try {
				...
				for (int i = 0; i <= size; i++) {
					webDriver.get(url + "/advertisement/setup/" + i);
					if (webDriver.getPageSource().contains(jobNameUpdtateConfig)) {
						WebElement findElement = webDriver.findElement(By.xpath(
								".//*[@id='adsetup']/tbody/tr/td/a[contains(text(),'" + jobNameUpdtateConfig + "')]"));
						String attribute = findElement.getAttribute("href");
						jobId = attribute.replace(url + "/advertisement?adsid=", "");
						System.out.println("attribute : " + jobId);
						assertEquals(jobNameUpdtateConfig, findElement.getText());
	...
	public void user_click_edit_job_name(String arg1) throws Throwable {
		...
		WebElement selectedTypeofSIM = webDriver
				.findElement(By.xpath(".//*[@id='create-form']/div[1]/div/div[2]/div[5]/div[2]/div/label[2]"));
		...
		WebElement selectedAnd = webDriver.findElement(By.xpath(".//*[@id='lifestyleE_1']/div/label[1]"));
		...
		WebElement selectedP0 = webDriver.findElement(By.xpath(".//*[@id='lifestyle_2']/div[4]/div/select/option[2]"));
		assertEquals("0%", selectedP0.getText());

		WebElement selectedP50 = webDriver.findElement(By.xpath(".//*[@id='lifestyle_2']/div[6]/div/select/option[7]"));
